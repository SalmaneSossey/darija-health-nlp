...
def train_transformer(
    ...
    output_dir = MODELS_DIR / f"transformer_{Path(model_name).name.replace('/', '_')}_{label_mode}"
    ...
    metrics_path = METRICS_DIR / f"transformer_{Path(model_name).name}_{label_mode}_metrics.json"
